...
__attribute__((swift_name("DateHelperIosKt")))
@interface MainDateHelperIosKt : KotlinBase
+ (NSString *)getCurrentDate __attribute__((swift_name("getCurrentDate()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DateHelperKt")))
@interface MainDateHelperKt : KotlinBase
